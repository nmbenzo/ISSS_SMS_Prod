...
def find_isss_advisor():
    ...
    for i in major_advisor.Nina:
        if i.lower() in INBOUND_MESSAGE and ('undergrad' in INBOUND_MESSAGE):
            return 'Nina'
        else:
    ...
    try:
        ...
        if ('appointment' in INBOUND_MESSAGE) or ('advisor' in INBOUND_MESSAGE):
            ...
            return str(resp)
                ...
                and ('credit' in INBOUND_MESSAGE) or (
                'full time' in INBOUND_MESSAGE) \
            ...
            return str(resp)
                ...
                or ('off campus' in INBOUND_MESSAGE) or (
                'job' in INBOUND_MESSAGE) \
